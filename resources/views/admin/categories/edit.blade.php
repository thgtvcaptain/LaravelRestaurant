                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <textarea id="description" rows="3" name="description" value="{{ $category->description }}"
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit"
                                class="px-4 py-2 bg-sky-500 hover:bg-sky-600 rounded-lg text-white">Update</button>
                        </div>
                    </form>
                </div>
